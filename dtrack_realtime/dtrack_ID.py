...
def RGB(event, x, y, flags, param): 
    if event == cv2.EVENT_MOUSEMOVE: 
        point = [x, y]
        print(point)
cv2.namedWindow('RGB') #tên cửa sổ hiện ra 
...
# cap = cv2.VideoCapture("D:\SourceCode\progarbage\yolov11\speed.mp4") #test
# cap = cv2.VideoCapture("D:\SourceCode\progarbage\yolov11\m.avi")  #test
